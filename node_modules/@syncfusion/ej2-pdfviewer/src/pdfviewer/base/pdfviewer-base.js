            ...
            if (proxy.pageSize[proxy.pageLimit - 1]) {
                ...
                for (var i_1 = proxy.pageLimit; i_1 < proxy.pageCount; i_1++) {
                    if (typeof (pageValues.pageSizes[parseInt(i_1.toString(), 10)]) !== 'object') {
                        ...
                        // eslint-disable-next-line max-len
                        var size = { width: (parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].width) ? parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].width) : parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].Width)), height: (parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].height) ? parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].height) : parseFloat(pageValues.pageSizes[parseInt(i_1.toString(), 10)].Height)), top: topValue };
                        proxy.pageSize.push(size);
                    }
                }
                // eslint-disable-next-line max-len
