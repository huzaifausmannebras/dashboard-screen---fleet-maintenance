...
var PDFExport = /** @class */ (function () {
    ...
    PDFExport.prototype.addPage = function (eventParams, pdfExportProperties) {
        ...
        var themeStyle = (!isNullOrUndefined(pdfExportProperties) && !isNullOrUndefined(pdfExportProperties.theme) &&
            !isNullOrUndefined(pdfExportProperties.theme.record)) ? pdfExportProperties.theme.record : undefined;
        var fontFamily = (!isNullOrUndefined(themeStyle) && !isNullOrUndefined(themeStyle.font) &&
            !isNullOrUndefined(themeStyle.font.name)) ? this.getFontFamily(themeStyle.font.name) : PdfFontFamily.TimesRoman;
        var fontSize = (!isNullOrUndefined(themeStyle) && !isNullOrUndefined(themeStyle.font) &&
            !isNullOrUndefined(themeStyle.font.size)) ? themeStyle.font.size : 10;
        var fontStyle = !isNullOrUndefined(themeStyle) ? this.getFontStyle(themeStyle) : PdfFontStyle.Regular;
