...
@import 'ej2-dropdowns/styles/drop-down-base/material3-dark-definition.scss';
...
@import 'ej2-navigations/styles/h-scroll/material3-dark-definition.scss';
@import 'ej2-navigations/styles/v-scroll/material3-dark-definition.scss';
